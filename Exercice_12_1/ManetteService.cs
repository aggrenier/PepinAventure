...
namespace IFM20884
{
    ...
    public class ManetteService : GameComponent, IInputService
    {
        ...
        private bool DelaiDuplicationExpire(int device, Buttons bouton, int delai)
        {
            ...
            this.heureDernierePression[device - 1, (int)bouton] = now;
            return true;
        }
        ...
        {
            bool etaitPresse = this.etatPrecedent[device - 1, (int)bouton];        // stocker l'état précédent
            ...
            this.etatPrecedent[device - 1, (int)bouton] = estPresse;
