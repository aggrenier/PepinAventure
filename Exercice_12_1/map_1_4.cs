//-----------------------------------------------------------------------
// <copyright file="Map_1_4.cs" company="Marco Lavoie">
...
namespace Exercice_12_1
{
    ...
    /// </summary>
    public class Map_1_4 : MondeImages
    {
        /// <summary>
        ...
        public static void LoadContent(ContentManager content, GraphicsDeviceManager graphics)
        {
            ...
            textures[0, 0] = content.Load<Texture2D>("Monde\\map_1_4\\map_1_4_0_0");
            textures[0, 1] = content.Load<Texture2D>("Monde\\map_1_4\\map_1_4_0_1");

            textures[1, 0] = content.Load<Texture2D>("Monde\\map_1_4\\map_1_4_1_0");
            textures[1, 1] = content.Load<Texture2D>("Monde\\map_1_4\\map_1_4_1_1");

            // Charger les textures de collisions, rangée par rangée
            texturesCollisions[0, 0] = content.Load<Texture2D>("Monde\\map_1_4\\map2Colision_0_0");
            texturesCollisions[0, 1] = content.Load<Texture2D>("Monde\\map_1_4\\map2Colision_0_1");

            texturesCollisions[1, 0] = content.Load<Texture2D>("Monde\\map_1_4\\map2Colision_1_0");
            texturesCollisions[1, 1] = content.Load<Texture2D>("Monde\\map_1_4\\map2Colision_1_1");
        }
        ...
        {
            return sprite.Position.X < 90 && (sprite.Position.Y > 251 || sprite.Position.Y < 295);
        }
    }
}
